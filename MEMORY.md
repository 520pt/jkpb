...
- 2026-07-31: The daily duty summary ("今日在岗") should not list next-month duty people in fields like tomorrow-early on the last day of a month. Rest transitions still need to look at the next calendar day, even when it is in the next month, so July 31 can report people who start resting on August 1 as "今日下午休息".
