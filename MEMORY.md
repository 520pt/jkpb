...
- 2026-07-31: The daily duty summary ("今日在岗") is month-scoped. On the last day of a month, do not use the next month's roster for tomorrow-early or rest transition calculations, even if the next month has already been imported.
